        ...
        <div>
            <footer className="text-gray-600 body-font">
                <div className="container px-5 py-5 mx-auto">
                    <div className="flex flex-wrap selection:md:text-left text-center order-first">
                        ...
                        <div className="lg:w-1/4 md:w-1/2 w-full px-4">
                            <h2 className="scroll-m-20 text-xl font-semibold tracking-tight  text-myBlackHead mb-3">
                                SERVICES
                            </h2>
                            <nav className="list-none mb-10">
                                <li>
                ...
                <div>
                    <div className="container px-5 py-5 mx-auto flex items-center sm:flex-row flex-col">
                        ...
                        <p className="text-xs font-semibold tracking-tight text-myBlackPara hover:text-MyBlackPara/70 sm:ml-6 sm:mt-0 mt-4">
                            © 2023
